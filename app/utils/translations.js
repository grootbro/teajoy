export const translations = {
  ...
  de: {
    ...
    policyText:
      "Прочтите нашу политику 3F и узнайте, как мы страстно стремимся к тому, чтобы предоставить вам не просто затяжку из бонга, а полноценный опыт, основанный на наших трех основных ценностях.",
    shippingText:
    ...
    backToProducts: "Обратно на витрину",
    ...
    shipping: "Доставка",
    total: "Всего",
    checkoutButton: "Купить",
    //CHECKOUT
    checkoutTitle: "Разместите ваш заказ",
    fullName: "Ваше имя",
    eMail: "Почта",
    shippingAddress: "Адрес",
    phoneNumber: "Телефон",
    placeOrderButton: "Заказать",
    fullNameRequired: "Введите ваше имя",
    eMailRequired: "Введите ваш E-Mail",
    addressRequired: "Введите ваш адрес",
    numberRequired: "Введите ваш телефон",
    //CONFIRMATION
    backToHome: "Обратно на главную",
    textPart1: "Ваш заказ получен,",
    textPart2: "Благодарим за ваш заказ.",
  },
  tr: {
    //NAVBAR
    home: "หน้าหลัก",
    ...
    policyText:
      "อ่านนโยบาย 3F ของเราและรู้ว่าเราพยายามทำให้คุณได้ประสบการณ์ที่แท้จริงไม่เพียงแค่แบบยึดหยุ่นเพียงอย่างเดียว แต่เป็นประสบการณ์ที่สมบูรณ์แบบ โดยมีความเชื่อมั่นใน 3 พื้นฐานของเรา.",
    shippingText:
    ...
    backToProducts: "กลับไปที่การซื้อสินค้า",
